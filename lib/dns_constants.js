...
var record_type = function(rt) {
  var r = CONSTANTS.RR_TYPES[rt]
  if (r) {
    return r
  }
  if (typeof(rt) == 'number') {
    if (between(rt, 52,54) || between(rt, 59,98) || between(rt, 104, 248) ||between(rt,256,32767) || between (rt, 32770, 65279)) {
      return "Unassigned"
    }
    if (between(rt, 65280, 65534)) {
      return "Private use"
    }
  ...
  throw new Error("unknown Record Type: "+rt)
...
[RFC5395]  D. Eastlake, "Domain Name System (DNS) IANA Considerations", 
